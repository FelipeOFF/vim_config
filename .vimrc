...
nnoremap <C-F>fa :FlutterRun<cr>
nnoremap <C-F>fq :FlutterQuit<cr>
nnoremap <C-F>fr :FlutterHotReload<cr>
nnoremap <C-F>fR :FlutterHotRestart<cr>
nnoremap <C-F>fD :FlutterVisualDebug<cr>
